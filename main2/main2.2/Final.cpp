...
int main()
{
	...
	/*
	Model piernaDer("resources/objects/nuevos/modelos/st_pd.obj");//Stewie
	...
	Model cuna("resources/objects/nuevos/modelos/cuna.obj");
	...
	while (!glfwWindowShouldClose(window)){
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(-40.0f, 39.0f, 60.0f));
