...
// camera
Camera camera(glm::vec3(0.0f, 160.0f, 220.0f));
...
void animate(void)
{
	...
	lightDirection.x = -(1 * cos(myVariable));
	lightDirection.y = 1 * sin(myVariable);
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		staticShader.setVec3("pointLight[1].position", glm::vec3(-110.0, 0.0f, 0.0f));
		staticShader.setVec3("pointLight[1].ambient", glm::vec3(0.0f, 0.8f, 0.0f));
		staticShader.setVec3("pointLight[1].diffuse", glm::vec3(0.0f, 0.8f, 0.0f));
		...
		staticShader.setVec3("pointLight[2].position", glm::vec3(110.0, 0.0f, 0.0f));
		staticShader.setVec3("pointLight[2].ambient", glm::vec3(0.0f, 0.0f, 0.8f));
		staticShader.setVec3("pointLight[2].diffuse", glm::vec3(0.0f, 0.0f, 0.8f));
		...
		staticShader.setVec3("pointLight[3].position", glm::vec3(0.0, 0.0f, 110.0f));
		staticShader.setVec3("pointLight[3].ambient", glm::vec3(colores.x, colores.y, 0.0f));
		staticShader.setVec3("pointLight[3].diffuse", glm::vec3(0.3f, 0.3f, 0.0f));
		...
		/*model = glm::translate(glm::mat4(1.0f), glm::vec3(-180.0f, 0.0f, -120.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(6.5f));
		staticShader.setMat4("model", model);
		casaBrujas.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(-270.0f, 90.0f, 100.0f));
